...
fn not_found() {
    ...
    cargo_process("install -v foo")
        ...
        .with_stderr_data(str![[r#"
[UPDATING] crates.io index
[CREDENTIAL] [..]//not_found//target//debug//not_found[EXE] get crates-io
{"v":1[..]
...
fn all_not_found() {
    ...
    cargo_process("install -v foo")
        ...
        .with_stderr_data(str![[r#"
[UPDATING] crates.io index
[CREDENTIAL] [ROOT]/not_found/target/debug/not_found[EXE] get crates-io
...
fn all_not_supported() {
    ...
    cargo_process("install -v foo")
        ...
        .with_stderr_data(str![[r#"
[UPDATING] crates.io index
[CREDENTIAL] [ROOT]/not_supported/target/debug/not_supported[EXE] get crates-io
{"v":1,"registry":{"index-url":"[..]","name":"crates-io","headers":[[..]"WWW-Authenticate: Cargo login_url=/"https://test-registry-login/me/""[..]]},"kind":"get","operation":"read"}
...
fn multiple_providers() {
    ...
    cargo_process("login -v abcdefg")
        ...
        .with_stderr_data(str![[r#"
[UPDATING] crates.io index
[CREDENTIAL] [ROOT]/url_not_supported/target/debug/url_not_supported[EXE] login crates-io
...
[CREDENTIAL] [ROOT]/success_provider/target/debug/success_provider[EXE] login crates-io
{"v":1,"registry":{"index-url":"https://github.com/rust-lang/crates.io-index","name":"crates-io"},"kind":"login","token":"abcdefg","login-url":"[ROOTURL]/api/me"}
